...
```{r, echo = FALSE}
ggsave("iy_with_words.jpeg", height = 5, width = 7, dpi = 300)
```
...
```{r, echo = FALSE}
ggsave("hex_plot.jpeg", height = 5, width = 7, dpi = 300)
```
...
```{r}
ggsave("waveform.jpeg", height = 3.5, width = 7, dpi = 300)
```
...
```{r, echo = FALSE}
ggsave("spec_points.jpeg", height = 5, width = 7, dpi = 300)
```
...
```{r, echo = FALSE}
ggsave("spec_raster.jpeg", height = 5, width = 7, dpi = 300)
```
